 ...
 *
 * Use {@link Inventories#writeNbt(NbtCompound, DefaultedList)} and {@link
 * Inventories#readNbt(NbtCompound, DefaultedList)} on {@linkplain #getItems() the item list}.
 *
...
public interface ImplementedInventory extends SidedInventory {
   ...
   *
   * <p>(default implementation) If there are less items in the slot than what are requested, takes
   * all items in that slot.
   *
   * @param slot the slot
   ...
   *
   * <p>If the stack is too big for this inventory ({@link Inventory#getMaxCountPerStack()}), it
   * gets resized to this inventory's maximum amount.
   *
   * @param slot the slot
   * @param stack the stack
   */
